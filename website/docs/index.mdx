...
<CardGroup cols={2}>
  ...
  <Card title="Handoff" href="/handoff" icon="arrow-right-left">
    The document a new session needs to continue this one, written by the agent
    CLI you already have. No API key.
  </Card>
